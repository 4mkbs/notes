...
import { validateEmail, validatePassword } from '../../utills/helper';
...
const SignUp = () => {
  ...
  const handleSignUp = async (e) => {
    ...
    if (!validatePassword(password)) {
      setError('please enter a strong password with minimum 8 characters, at least one uppercase letter, one lowercase letter, one number and one special character');
      return;
    }
    setError("");
